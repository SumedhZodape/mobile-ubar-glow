...
const Home = () => {
  ...
  const [rideStatus, setRideStatus] = useState<'booking' | 'searching' | 'matched' | 'enroute' | 'arrived'>('booking');
    ...
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 relative">
        <MapView 
          ...
          driverLocation={rideStatus === 'matched' ? { lat: 40.7128, lng: -74.0060 } : undefined}
        />
        ...
        {rideStatus === 'searching' && (
          <div className="absolute bottom-6 left-4 right-4">
            <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-200 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Looking for a driver...</h3>
      ...
      >
        <div className="space-y-6">
          ...
          >
            Confirm {selectedRideType === 'uberx' ? 'UberX' : selectedRideType === 'uberxl' ? 'UberXL' : 'Uber Black'}
          </button>
        </div>
      </BottomSheet>
    </div>
